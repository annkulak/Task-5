import { picturesAlbum } from './slides.js';
...
function slideNext() {
    if (indexPicture < picturesAlbum.length - 1) {
        memoryIndexPicture = indexPicture;
        indexPicture = ++indexPicture;
    };
};
...
function buttonAnimation() {
    ...
    } else if (indexPicture === picturesAlbum.length - 1) {
...
export { photoSliderMove, sketchesActivity };